 ...
 */
export function smoothScrollTo(targetId: string, additionalOffset: number = 10): void {
 ...
 * @param additionalOffset - Optional additional offset in pixels
 */
export function handleNavClick(event: Event, href: string, additionalOffset: number = 10): void {
